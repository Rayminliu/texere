...
python -m pytest -q                                              # 219 assertions, ~6-7 min (needs local Word)
```
...
python -m pytest -q                                    # full suite: 219 assertions, ~6-7 min
```
