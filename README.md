...
python -m pytest -q                                              # 218 assertions, ~6-7 min (needs local Word)
```
...
python -m pytest -q                                    # full suite: 218 assertions, ~6-7 min
```
